...
@section('title', 'Add Bed - hypercare')
...
@section('content')
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
        <div>
            ...
            <h1 class="text-3xl font-black tracking-tight text-text">Add Bed</h1>
        </div>
                ...
                <x-ui.card>
                    <div class="flex items-center gap-4 mb-8">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-text-faint font-medium">Enter details for the new bed.</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" id="bed_number" name="bed_number" value="{{ old('bed_number') }}" required 
