...
@section('title', 'New Appointment - hypercare')
...
@section('content')
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
        <div>
            ...
            <h1 class="text-3xl font-black tracking-tight text-text">New Appointment</h1>
        </div>
    ...
    <form method="POST" action="{{ route('polyclinic-appointments.store') }}">
        @csrf
                ...
                <x-ui.card>
                    <div class="flex items-center gap-4 mb-8">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-text-faint font-medium">Select patient and preferred schedule.</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea id="notes" name="notes" rows="3"
                                ...
                                placeholder="Any additional notes for the appointment...">{{ old('notes') }}</textarea>
                            @error('notes')
                                <p class="text-xs font-bold text-red-500 mt-2 flex items-center gap-1">
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line></svg>
                                    {{ $message }}
            ...
            <div class="space-y-6">
                <x-ui.card class="bg-gradient-to-br from-bg to-bg/50 border-accent/10">
                    ...
                    <p class="text-xs text-text-faint font-medium leading-relaxed mb-4">
                        Upon saving, the system will automatically assign the next available Queue Number for the selected doctor schedule and date.
                    </p>
                    <ul class="space-y-3">
                        <li class="flex items-start gap-2 text-xs text-text-muted font-medium">
                            ...
                            Ensure the date matches the doctor's active day of the week.
                        </li>
                    </ul>
                </x-ui.card>
